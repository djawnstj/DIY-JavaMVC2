package com.djawnstj.mvcframework.web.method;

import com.djawnstj.mvcframework.ui.Model;
...
public class HandlerMethod {
    ...
    private Object[] initParameters(final HttpServletRequest req, final HttpServletResponse resp, final ModelAndViewContainer mavContainer) throws Exception {
        ...
        Arrays.stream(this.method.getParameters()).forEach(parameter -> {
            ...
            else if (ServletResponse.class.isAssignableFrom(parameterType)) parameterList.add(resp);
    ...
    public void handle(final HttpServletRequest req, final HttpServletResponse res, final ModelAndViewContainer mavContainer) throws Exception {
